 ...
 * </code>
 */
public class HletHelper {

    private static final Logger LOG = LoggerFactory.getLogger(HletHelper.class);
    ...
    public Sresult doSpecial(Cell seq, Environ environ) {
        ...
        if (lambdaList != null) {
            ...
            Object undefList = sameLengthUndef(lambdaList);
  ...
  //      return new Cell(1L, sameLengthUndef(RT.cdr(list)));
    }
